...
var UserSchema = new _mongoose.Schema({
  ...
  customerId: [{ type: _mongoose.Schema.Types.ObjectId, ref: "Customer" }],
  partyId: [{ type: _mongoose.Schema.Types.ObjectId, ref: "Party" }],
  location: {
    type: String,
...
UserSchema.plugin(_mongooseAutoIncrement2.default.plugin, { model: 'User', field: 'userId', startAt: 1, incrementBy: 1 });
